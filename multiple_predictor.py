...
def multiple_predict(threshold):
    ...
    supported_list = ['banana', 'orange', 'mixing_bowl', 'soup_bowl', 'washbowl', 'washbasin', 'handbasin', 'lavabo', 'wash-hand basin', 'custard apple','pomegranate', 'beer_bottle', 'pop_bottle', 'soda_bottle', 'water_bottle', 'wine_bottle', 'sundial', 'bathtub', 'mortar', 'orange']
    ...
    objects = [i if i not in ['soup_bowl', 'washbowl', 'washbasin', 'handbasin', 'bathtub', 'mortar'] else 'mixing_bowl' for i in objects]
    objects = list(set(objects))
